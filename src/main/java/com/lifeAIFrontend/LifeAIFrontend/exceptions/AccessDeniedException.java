package com.lifeAIFrontend.LifeAIFrontend.exceptions;
...
public class AccessDeniedException extends ApiException {
    public AccessDeniedException(MessageSource messageSource) {
        super(messageSource.getMessage("Няма достъп", null, LocaleContextHolder.getLocale()), HttpStatus.FORBIDDEN);
    }
}
